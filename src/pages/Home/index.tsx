...
import {HomeContainer, FormContainer, CountdownContainer, Separator, StartCountdonwButton, TaskInput,MinutesAmountInput, StopCountdonwButton} from './styles'
            ...
            <form onSubmit={handleSubmit(handleCreateNewCycle)}>
                <FormContainer>
                    ...
                    <datalist id="task-suggestions">
                        <option value="Estudar Javascript"></option>
                        <option value="Estudar React"></option>
                        <option value="Praticar Logica"></option>
                    </datalist>
